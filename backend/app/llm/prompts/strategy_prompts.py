...
def _phase_instruction_zh(question_count: int, max_questions: int) -> str:
    if question_count <= 2:
...
def _phase_instruction_en(question_count: int, max_questions: int) -> str:
    if question_count <= 2:
...
def build_strategy_prompt(
    ...
    phase_instr = (
        _phase_instruction_zh(question_count, max_questions)
        if language == "zh"
        else _phase_instruction_en(question_count, max_questions)
    )
